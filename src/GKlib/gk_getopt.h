...
/* Function prototypes */
extern int gk_getopt(int, char **, char *);
extern int gk_getopt_long(int, char **, char *,
              struct gk_option *, int *);
extern int gk_getopt_long_only (int, char **,
              char *, struct gk_option *, int *);
